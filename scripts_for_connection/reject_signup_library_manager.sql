-- rejecting library manager signup

DELIMITER //

DROP PROCEDURE IF EXISTS reject_signup_library_manager //

CREATE PROCEDURE reject_signup_library_manager(
...
-- CALL reject_signup_library_manager('godinternal', '8QvDwYh3F!kSPS3b', 'John', 'Stefanopoulos', '1974-04-22', '477-778-5386');
